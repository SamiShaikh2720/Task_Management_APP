...
//   const task = globalTaskData.find(task => task.id === targetID);
...
//     // You can display the task details in a modal, alert, or any other UI component
//     alert(taskDetails);
//   } else {
...
<div class="card">
  ...
  <button class="btn btn-outline-primary" name="${taskData.id}" onclick="openTask('${taskData.id}')">Open Task</button>
...
const openTask = (taskId) => {
  const task = globalTaskData.find(task => task.id === taskId);
  ...
  if (task) {
    ...
    taskDetailsContainer.innerHTML = `
      ...
      <img src="${task.image}" alt="Task Image" class="img-fluid">
    `;
